...
### CUB-200
# R128
python dual_main.py --loss proxyvmf_panc --seed 0 --gpu $gpu --source_path $parent_folder --project $project --log_online --group Cub200_Prob_RN50_dim128 --dataset cub200 \
...
# R512
python dual_main.py --loss proxyvmf_panc --seed 0 --gpu $gpu --source_path $parent_folder --project $project --log_online --group Cub200_Prob_RN50_dim512 --dataset cub200\ 
